...
const Hero = () => {
    return (
        <motion.div className="min-h-screen overflow-hidden bg-slate-900 dark:-mb-32 dark:mt-[-6.5rem] dark:pb-32 dark:pt-[4.5rem] dark:lg:mt-[-6.75rem] dark:lg:pt-[4.75rem]">
