    ...
    return (
        <section id="why" className="container">
            <motion.h1
                variants={fadeLeft}
                {...motionStep}
                className="flex sm:items-center gap-2 text-lg md:text-3xl font-medium text-slate-300"
            >
            ...
            <motion.div
                variants={fadeLeft}
                {...motionStep}
                className="cols-span-2 mt-10 max-w-[700px] rounded-2xl overflow-hidden"
            >
